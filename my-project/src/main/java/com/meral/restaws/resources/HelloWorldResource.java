...
public class HelloWorldResource {
    ...
    public Saying sayHello(@QueryParam("name") Optional<String> name, 
    	...
    	//3- it receives the request status (failure or sucess) from kinesis
		...
		NameDateIpUaId ndiui = makeNDIUI(name, request.getRemoteAddr(), userAgent);
		byte[] bytes = null;
		try {
		...
		System.out.println("sending data: " + JSON.writeValueAsString(ndiui));
